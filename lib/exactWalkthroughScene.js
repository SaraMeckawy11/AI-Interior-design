...
export const LIVINAI_WEB_RENDERER_REVISION = "current-furniture-fixed-walls-v36";
...
(function(){
  ...
  var engine={yaw:Number(data.spawnYaw)||0,pitch:-0.04,orbitAngle:0.72,orbitPitch:0.72,selected:null,selectionBox:null,drag:false,moved:0,lastX:0,lastY:0,joystick:{x:0,y:0},furniture:[],ceilings:[],overheads:[],userPose:null,clock:new THREE.Clock()};
