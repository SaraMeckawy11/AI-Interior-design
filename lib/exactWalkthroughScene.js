...
(function(){
  ...
  var applyLighting=function(){var bird=state.mode==='plan';threeScene.background.set(state.night?0x132333:0xc9d5d8);renderer.toneMappingExposure=state.night?0.84:0.8;if(environment)threeScene.environmentIntensity=bird?(state.night?0.24:0.38):(state.night?0.3:0.48);hemisphere.intensity=bird?(state.night?0.38:0.62):(state.night?0.48:0.85);sun.intensity=bird?(state.night?0.45:1.2):(state.night?0.7:1.7);roomPointLights.forEach(function(light){light.intensity=bird?(state.night?3.8:0.65):(state.night?8:2.2);});};
