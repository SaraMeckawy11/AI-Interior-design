 ...
 * What a room can be.
 *
 * One of these names carries a decision rather than just a label, and it is
 ...
 *
 * Salon and Salon + Dining are no longer offered here. The renderer still knows
 * what to do with those names, so a plan saved when they were on the list — or
 * a room typed in by hand — is furnished exactly as it always was.
 */
