...
const API_KEYS = {
  ...
  // RevenueCat SDK keys identify the app and are intentionally public. The
  // fallback matters for development clients: local Metro does not inherit the
  // environment block from eas.json, which previously left iOS unconfigured
  // and unable to return StoreKit's localized (including EGP) prices.
  ios:
    process.env.EXPO_PUBLIC_REVENUECAT_IOS_API_KEY ||
    'appl_QuKzBCGnKgsizsdRDpQDQJaZXkN',
};
