    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Section title="General">
        <Text style={styles.text}>
          Roomify ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Roomify.
        </Text>
        <Text style={styles.text}>
          By accessing or using our mobile application, Roomify, you agree to the collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
        </Text>
      </Section>
      ...
      <Section title="Definitions and Key Terms">
        ...
        <Bullet text="Device: Any connected device (e.g., phone, tablet, computer) used to access Roomify." />
        <Bullet text="Service: Refers to Roomify and its features." />
      </Section>
      ...
      <Section title="User Rights">
        <Text style={styles.text}>
          ...
          <Text style={styles.link} onPress={() => Linking.openURL('mailto:privacy@roomify.app')}>
            privacy@roomify.app
          </Text>.
        </Text>
      </Section>
      ...
      <Section title="In-App Purchases">
        <Text style={styles.text}>
          Payments are processed securely through the Apple App Store or Google Play Store. Roomify does not store any credit card or payment details.
        </Text>
      </Section>
      ...
      <Section title="Changes to this Policy">
        <Text style={styles.text}>
          We may revise this Privacy Policy from time to time. Significant changes will be communicated via app updates or email. Continued use of Roomify implies acceptance of any updates.
        </Text>
      </Section>

      <Section title="Contact Us">
        <Text style={styles.text}>
          Email: <Text style={styles.link} onPress={() => Linking.openURL('mailto:privacy@roomify.app')}>privacy@roomify.app</Text>{'\n'}
